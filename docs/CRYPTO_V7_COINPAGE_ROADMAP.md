...
- [x] CP-4 **Chart candle truth**: Chart.tsx crypto path joins by
...
- [x] CP-7 **Sweep**: full prod pass — for BTC, ETH, GRAM, HYPE (okx
...
- **CP-7 sweep GREEN** (2026-07-14): audit spot 200/200 live-last 200, MISMATCH 0 (one transient stale-blob run self-healed on SWR refresh). 5-coin pass — BTC (profile rank1, 20 tickers Binance top, 13 yield pools, chart gate 0.00%, news CoinDesk/Bloomberg/TheBlock), ETH (gate 0.23%, 15 pools), GRAM=the-open-network (own GRAM/USDT $1.62 tickers, storm-trade 6.25% yield, gate 0.31%, zero BTC data anywhere), HYPE okx-venue (Hyperliquid HYPE/USDC tickers, gate 0.01%), PEPE (own $0.00000279 tickers, gate 0.36%). CG 429 bursts on cold blobs = honest empty+retry by design; blobs warm on first success then stale-serve. TN regression: board 200 1.2s (BIAT 170 TND real), intraday 200; /trading 200 0.36s paint unchanged. V7 COMPLETE 7/7.
