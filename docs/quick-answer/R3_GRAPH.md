...
**Score: 3 live (T3–T5) · 2 closed (T1, T2) · 2 architectural risk (T6, T11) · 1 unverified (T7) · 1 partially rebutted (T8) · 1 wording (T9) · 1 method (T10) · 1 roadmap defect (T12).**

**T5 was found by the loop, not the audit — the third round running to find one of these.
T11 and T12 were also found by the loop, in L1, and neither is in any audit.**
