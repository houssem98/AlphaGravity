...
- [x] CS-8 **QA sweep**: prod curl all 3 views; toggle every group live;
...
- 2026-07-12 CS-8 QA: all 3 prod views green — markets 100 rows src=coingecko (BTC 64054, p1y -45.4, fdv 1.284T); technicals BTC rsi53/Sell ETH rsi60/Buy XRP rsi46 BNB rsi51 SOL rsi53; derivatives BTC f0.008%/$6.5B ETH $4.2B XRP $0.4B BNB $0.3B SOL $0.7B. Structural audit: 30/30 toggleable cols exactly 1 th + 1 td (parity script), overflow-x-auto present, colCount dynamic. TN regression: board 200, intraday 200 (tn/groups+indices 404 = never routes, internal helpers). ROADMAP COMPLETE 8/8.
