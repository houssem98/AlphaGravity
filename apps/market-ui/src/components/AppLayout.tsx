...
export default function AppLayout() {
    ...
    return (
        <div className="min-h-dvh flex bg-[color:var(--bg)] text-[color:var(--text-2)]">
            {/* Sidebar */}
            <aside className="w-14 bg-[color:var(--surface)] border-r border-[color:var(--line)] hidden desk:flex flex-col items-center py-3 fixed h-full z-50">
                <Link
                    to="/search"
            ...
            <div className="flex-1 min-w-0 desk:ml-14 h-dvh desk:h-auto pt-12 desk:pt-0 flex flex-col desk:block">
                <header className="h-12 bg-[color:var(--surface)] border-b border-[color:var(--line)] flex items-center justify-between px-3 fixed top-0 right-0 left-0 desk:left-14 z-40 fade-in">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="label ml-1 hidden desk:inline">MARKET INTELLIGENCE</span>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-6 h-6 rounded-sm bg-[color:var(--surface-2)] border border-[color:var(--line)] hidden desk:block" />
                    </div>
                </header>
                ...
                <main className="flex-1 overflow-y-auto desk:overflow-visible desk:pt-12 desk:min-h-dvh bg-[color:var(--bg)]">
                    <Outlet />
                </main>
