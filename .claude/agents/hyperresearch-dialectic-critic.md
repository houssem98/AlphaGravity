...
2. **Search the vault for counter-evidence.** Use
   `C:/Users/unicentrale/Downloads/antigravity/.venv-hr/Scripts/hyperresearch.exe search "<keyword>" --tag <vault_tag> -j` to find interim
   ...
   (`C:/Users/unicentrale/Downloads/antigravity/.venv-hr/Scripts/hyperresearch.exe note show <id> -j`).
