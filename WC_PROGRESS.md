...
- [ ] W0d fix macro/thematic failure mode: server fetch bodyTimeout (undici 300s default kills long monolith calls) + budget rebalance so fanout isn't starved; re-run 2 queries → 5/5 baseline
